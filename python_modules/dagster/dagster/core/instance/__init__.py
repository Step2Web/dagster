...
from dagster.core.types.config_plugin import construct_from_configurable_plugin_data
...
class DagsterInstance:
    ...
    def from_ref(instance_ref, fallback_feature_set=None):
        ...
        local_artifact_storage = construct_from_configurable_plugin_data(
            instance_ref.local_artifact_storage_data
        )
        run_storage = construct_from_configurable_plugin_data(instance_ref.run_storage_data)
        event_storage = construct_from_configurable_plugin_data(instance_ref.event_storage_data)
        compute_log_manager = construct_from_configurable_plugin_data(
            instance_ref.compute_logs_data
        )
