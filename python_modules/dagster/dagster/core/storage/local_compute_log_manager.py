...
def local_compute_log_manager_config_plugin(plugin_config):
    return LocalComputeLogManager(base_dir=plugin_config['base_dir'])


# class LocalComputeLogManagerConfigPlugin(ConfigPlugin):
#     @classmethod
#     def config_type(cls):
#         return SystemNamedDict('SqliteEventLogStorageConfigPlugin', {'base_dir': Field(String)})

#     @staticmethod
#     def from_plugin_config_value(plugin_config_value):
#         return LocalComputeLogManager(base_dir=plugin_config_value['base_dir'])


class LocalComputeLogManager(ComputeLogManager):
